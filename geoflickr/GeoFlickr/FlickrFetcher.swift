...
let FLICKR_RESULTS_PHOTOS: NSString = "photos.photo"
let FLICKR_RESULTS_PLACES: NSString = NSString(string: "places.place")

//keys to values in photo dictionary
let FLICKR_PHOTO_TITLE: NSString = "title"
let FLICKR_PHOTO_DESCRIPTION: NSString = "description._content"
let FLICKR_PHOTO_ID: NSString = "id"
let FLICKR_PHOTO_OWNER: NSString = "ownername"
let FLICKR_PHOTO_UPLOAD_DATE: NSString = "dateupload"
let FLICKR_PHOTO_PLACE_ID: NSString = "place_id"

//keys to values in a places dictionary (TopPlaces)
let FLICKR_PLACE_NAME: NSString = "_content"
let FLICKR_PLACE_ID: NSString = "place_id"

//keys applicable to all types of Flickr dictionaries
let FLICKR_LATITUDE: NSString = "latitude"
let FLICKR_LONGITUDE: NSString = "longitude"
let FLICKR_TAGS: NSString = "tags"
